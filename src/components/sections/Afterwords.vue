...
<template>
    <section id="afterwords">
        <h2>Afterwords</h2>
        <p>
            Hello! If you made it this far, thank you so much for reading my blog. I really hoped you enjoyed it. My journey towards HENNGE was life-changing. It pushed me to learn new technologies, to try out different things. I made this blog specifically for HENNGE. I wanted to thank them somehow, and show my appreciation for helping me.
        </p>
        <p>
