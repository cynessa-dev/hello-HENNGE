<script setup lang="ts">
  ...
  const suiImages = [
    ...
    {
      src: suiTeamWithFaculty,
      alt: 'SUI After',
    },
  ]

  const raiteHackathonImage = [
    {
      src: raiteHackathon,
      alt: 'RAITE Groupie',
    },
...
<template>
  <section id="the-journey">
    ...
    <p>
      ...
      knowledge to build new solutions to new challenges. One such instance was when I was studying
    ...
    <p>
      After gaining new knowledge, only then I can spot the mistakes I made. One of which was bad
